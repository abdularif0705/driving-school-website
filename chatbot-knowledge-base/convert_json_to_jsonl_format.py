...
dataset = {
    ...
    },
    {
      ...
      "responses": [
        ...
        "The cost of driving lessons varies depending on the package you choose. The cost of a single driving class is $40/hour. However, our most popular package is 10 lessons for $400, and you get the BDE certificate for free with the package, whereas the usual price for the BDE is $250."
      ]
    },
    {
      "tag": "pricing",
